...
const Header = observer(() => {
  ...
  function handleGitHubRedirect(e) {
    let redirectConfirmed = window.confirm('Вы желаете перейти на другой сайт? (Он откроется в этой же вкладке)')
    ...
    <div style={{margin: '0 5%'}}>
      <header className={style.header}>
        ...
        <div className={style.navContainer}>
          ...
          <a className={style.navBtn} onClick={ e => handleGitHubRedirect(e) }
          href='https://github.com/4Tipsy/topicco'>GitHub</a>
        ...
        <div className={style.userBtnsContainer}>
          ...
          <Link to={'/cart'} className={style.cart}>
            ...
            <div className={style.cartAmountIndicatorWrapper}>
              <div className={style.cartAmountIndicator}>{cart.itemsAmount}</div>
            </div>
          </Link>
